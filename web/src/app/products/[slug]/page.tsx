                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <a href={`https://wa.me/919746952443?text=Hello, I would like to inquire about the ${encodeURIComponent(product.name)}`}
                        className="group flex items-center justify-center gap-2 bg-[#0D7A9E] text-white px-4 py-4 font-sans text-[11px] font-semibold tracking-[0.2em] uppercase hover:bg-[#178CB5] transition-colors duration-300">
