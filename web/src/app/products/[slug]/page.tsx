              ...
              <div className="sticky top-32">
                ...
                <div className="bg-[#F8F9FA] p-8 border border-[#E5E7EB]">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <a href={`https://wa.me/914842345678?text=Hello, I would like to inquire about the ${encodeURIComponent(product.name)}`}
                      target="_blank" rel="noopener noreferrer"
                      className="group inline-flex items-center justify-center w-full gap-3 border border-[#0A2333] text-[#0A2333] px-8 py-4 font-sans text-[11px] font-semibold tracking-[0.2em] uppercase hover:bg-[#0A2333] hover:text-white transition-all duration-300">
