              ...
              <div className="sticky top-32">
                ...
                <div className="bg-[#F8F9FA] p-8 border border-[#E5E7EB]">
                  ...
                  <div className="flex flex-col gap-4">
                    <a href={`https://wa.me/918848162343?text=Hello, I would like to inquire about the ${encodeURIComponent(product.name)}`}
                      className="inline-flex items-center gap-2 bg-[#0D7A9E] text-white px-8 py-4 font-sans text-[11px] font-semibold tracking-[0.2em] uppercase hover:bg-[#178CB5] transition-colors duration-300">
